...
export const MODEL_REGISTRY: Record<string, ModelInfo> = {
  ...
  'claude-opus-4-20250514': {
    ...
    capabilities: ['vision', 'extended_thinking', 'tool_use'],
    isFree: false,
  },
  ...
  'gemini-2.5-pro-preview-05-06': {
    ...
    capabilities: ['vision', 'audio', 'function_calling', 'thinking'],
    isFree: false,
  },
  ...
  // Local Ollama (free)
  'llama3.2': {
    endpoint: 'custom', provider: 'Ollama (Local)',
...
/** Map model ID → LibreChat endpoint name */
...
/** Group models by provider for the React dropdown */
...
/** Smart model recommender based on task requirements */
export function recommendModel(task: {
  ...
  return 'claude-sonnet-4-20250514'; // default: best balance
}
